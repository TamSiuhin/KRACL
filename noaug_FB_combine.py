...
from model import CLKG_compgatv3_convE, CLKG_compgatv3_transE, SupConLoss, relation_contrast, CLKG_compgatv3_distmult, CLKG_compgatv3_rotatE
...
parser.add_argument("--proj", type=str, default="conve", help="knowledge graph dataset path")
...
def main():
    ...
    if args.proj.lower() == "conve":
        model =  CLKG_compgatv3_convE(args)
    elif args.proj.lower() == "distmult":
        model =  CLKG_compgatv3_distmult(args)
    elif args.proj.lower() == "rotate":
        model =  CLKG_compgatv3_rotatE(args)
    elif args.proj.lower() == "transe":
        model =  CLKG_compgatv3_transE(args)
    else:
